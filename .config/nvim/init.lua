...
require('lazy').setup({
  ...
  -- Hop.nvim for quick cursor jumping
  {
    ...
    keys = {
      { 's', function() require('hop').hint_char2() end, desc = 'Hop to 2 chars' },
      { 'S', function() require('hop').hint_lines_skip_whitespace() end, desc = 'Hop to line' },
    },
  },
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      local ensure_installed = { 'bash', 'c', 'diff', 'go', 'gomod', 'gosum', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' }
...
-- Ctrl-p for file finding (muscle memory from fzf)
...
-- Go to definition (classic gd instead of grd)
